...
*/
    ...
    grunt.registerTask("build:mobile", [ "env:dev", "eslint", "clean:build", "copy:main", "requirejs:mobile", "imageEmbed:mobile", "preprocess:mobile", "clean:post-mobile", "copy:mobileBuildOutput", "phonegap:build" ]);
    grunt.registerTask("build:web", [ "env:dev", "eslint", "clean:build", "copy:main", "copy:nodeModules", "requirejs:web", "imageEmbed:web", "preprocess:web", "clean:post-web" ]);
    grunt.registerTask("build:demo", [ "env:dev", "eslint", "clean:build", "copy:main", "requirejs:demo", "copy:demo", "imageEmbed:web", "preprocess:web", "clean:post-web" ]);

    grunt.registerTask("release:mobile", [ "env:mobile", "eslint", "clean:build", "copy:main", "requirejs:mobile", "imageEmbed:mobile", "preprocess:mobile", "clean:post-mobile", "copy:mobileBuildOutput", "phonegap:build", "phonegap:release" ]);
    grunt.registerTask("release:web", [ "env:web", "eslint", "clean:build", "copy:main", "copy:nodeModules", "requirejs:web", "imageEmbed:web", "preprocess:web", "clean:post-web" ]);
